...
<base href="http://10.0.0.1/Pageflakes/" ></base>
<script type="text/javascript">
    try { if (document.execCommand) document.execCommand("BackgroundImageCache", false, true); } catch (err) { }
</script>
<link rel="alternate" type="application/rss+xml" title="RSS" href="http://www.pageflakes.com/insider?feed=rss2" />
<link id="themeStylesheet" href="/Pageflakes/s.axd?s=css1&h=localhost" rel="stylesheet" type="text/css" />
<link id="pagetheme_T12" href="/Pageflakes/p.axd?i=12&t=&h=http://localhost/pageflakes&v=4&b=AppleMAC-Safari&m=5" rel="stylesheet" type="text/css" />
<script type="text/javascript">
    var l = {};
    l.startDateTime = new Date();
    var SITE_PREFIX = "http://Localhost/Pageflakes";
    var RSS_FEED_FLAKE_URL = "__RSSFEED__?url=";
    var IMAGE_PREFIX = "http://LocalHost/Pageflakes/images/";
    var SOURCE = '';
    var PAGE_ID = '';
    var VERSION_SUFFIX = '217en';
    var LANGUAGE = 'en';
    var loadFeedWithSingleConnection = false;
    var op = /opera 5|opera\/5/i.test(navigator.userAgent) && window.opera; var ie = !op && /msie/i.test(navigator.userAgent); var mz = !op && /mozilla\/5/i.test(navigator.userAgent); var safari = /Safari/i.test(navigator.userAgent); function $reload(msg) { if (confirm("Problem occured while loading site. Press OK to retry.\nProblem:" + msg)) document.location.reload(true); }
    //document.cookie = "j=1c743837a4505842588f729f0d716127; path=" + document.location.host;
</script>
</head>
<body>
<noscript><p>This page is designed for JavaScript-only browsers. In case you have disabled JavaScript, please enable it and reload this page.</p><p>Alternatively, consider installing a JavaScript capable browser such as <a href="http://www.getfirefox.com/">Mozilla Firefox</a>.</p></noscript><div id="blockUI" style="display: none; background-color: black; width: 100%; height: 100px; position: absolute; left: 0px; top: 0px; z-index: 50000; -moz-opacity: 0.5; opacity: 0.5; filter: alpha(opacity=50);" onclick="return false" onmousedown="return false" onmousemove="return false" onmouseup="return false" ondblclick="return false">&nbsp;</div>
<div id="Content" class="T12 ">
<div id="alerts" class="alerts" style="display:none"><div id="alertMessages" class="alertMessages"></div></div><span id="DomainSuperHeader"></span><div id="header">
<div id="header_extra">
...
<li><a href="javascript:UserRegistration('?track=hpheader')" id="SignupLink">
Sign up
&nbsp;|&nbsp;</a></li>
<li id="LoginLink"><a href="http://www.pageflakes.com/Login.aspx?track=hpheader">
Login
</a>&nbsp;|&nbsp;</li>
<li id="ReaderLink"><a href="javascript:void(0)" onclick="FeedViewer.loadRssReaderDiv2()" id="RssReaderLink">
Reader</a>&nbsp;|&nbsp;</li>
<li id="SetAsHomePage"><a id="SetAsHomePageLink" href="javascript:void(0)" onmouseover="if(typeof StartPageHelper != 'undefined') StartPageHelper.attachLink(this)">
Make this my homepage</a></li>
</ul>
<!-- Search Google -->
...
<div id="CommunityButton" style="display: none" title="Browse other people�s profiles, public pages, and get even more stuff for your page"
onclick="$trackEventNoTimeOut('Community Button','Click', 'Direct Click'); document.location.href='community/'">
Community</div>
...
<div id="tabs_container_scroll"><div id="tabs_container"><ul id="tabs" class="tabs"></ul></div></div>
<div id="right_scroll">&gt;</div>
</td>
<td valign="top" id="TopMenuContainer" align="right"><div style="width: 200px;">&nbsp;</div></td>
</tr>
</table>
<div class="pushdown">
</div>
...
<span id="HideThisMessageLink"><a href="javascript:void(0)" onclick="$nodisplay('messageBar')"
id="messageBarClose">
Hide this message
</a></span><span id="errorMsg"></span>
<div class="pushdown">
</div>
</div>
...
<div class="pushdown">
&nbsp;</div>
<div id="busyUI" style="display: none; background-color: black; width: 100%; height: 100px;
position: absolute; left: 0px; top: 0px; z-index: 50001; -moz-opacity: 0; opacity: 0;
filter: alpha(opacity=0); cursor: wait" onclick="return false" onmousedown="return false"
onmousemove="return false" onmouseup="return false" ondblclick="return false">
&nbsp;</div> <!-- Zone des pages/flakes -->
...
<b></b>
<div class="sendFlakeOptions" onclick="FlakeMenu.emailFriend();" onmouseover="hover(this)"
onmouseout="hout(this)">
<strong>Email to a friend</strong></div>
<div class="sendFlakeOptions" onclick="FlakeMenu.putInBlog();" onmouseover="hover(this)"
onmouseout="hout(this)">
<strong>Take Flake</strong></div>
</div>
<style>
.footer_wrapper
{
...
<script type="text/javascript" id="StartupJSON">
    var __getJsonQueryString = '?r=634981643274503346';
    document.write('<' + 'script type="text/javascript" id="GetJSON" src="/Pageflakes/GetJSON.ashx' + __getJsonQueryString + '"> <' + '/script>');
</script>
<script src="/Pageflakes/f.axd?s=Framework&t=j&v=217en&l=en" type="text/javascript" ></script>
...
<script type="text/javascript" language="Javascript" src="/Pageflakes/JavaScripts/GoogleAnalyticsPF.js"></script><script type="text/javascript" >
