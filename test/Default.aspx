...
<head>
    ...
    <link id="themeStylesheet" href="s.axd?s=CSS1&h=www.Pageflakes.com&l=en&v=204en&b=Unknown&m=0" rel="stylesheet" type="text/css" />
...
var IMAGE_PREFIX = "http://www.Pageflakes.com/images/";
...
<body>
<div class="T12">
<div id="alerts" class="alerts" style="display:none"><div id="alertMessages" class="alertMessages"></div></div>
<div id="header">
	<div id="header_extra">
...
<div class="Start" id="Start"><div class="add_right">&nbsp;</div></div>
	</td></tr>
	<tr><td id="tabs_container_td">
	            <ul id="tabs" class="tabs">

		    <li class="T12_tab"><div class="page_tab"><div class="page_title">Page One</div></div></li>
		    <li class="T12_tab"><div class="page_tab_off"><div class="page_title">Page Two</div></div></li>
...
<div id="blockUI" style="display: none; background-color: black;
    width: 100%; height: 5000px; position: absolute; left: 0px; top: 0px; z-index: 50000;     
...
<script id="PostFrameworkLoaderScript" type="text/javascript" >
    ...
    <form name="aspnetForm" method="post" action="login.aspx?ReturnURL=%2fDefault.aspx%3fuserName%3d'+++homeURL+++'&amp;" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTgyOTc5NDYwNmRk2n2XsSrgDmWzNtDAVwI7eYniXak=" />
...
<input type="hidden" id="returnUrlFromLogin" name="returnUrlFromLogin" /> 
<input type="hidden" id="loginSuccess" name="loginSuccess" value="success" /> 
       
<div id="Login" class="wizardbox popup container hidden" >
    <div class="header">
        <a class="Start_Wizard_Back" href="default.aspx" >Back</a>
    </div>
    <div class="content">
